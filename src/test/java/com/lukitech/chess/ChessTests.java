...
import com.lukitech.chess.interpreter.InterpreterTest;
...
@Suite
@SelectClasses({PawnTest.class, BoardTest.class, BishopTest.class, KnightTest.class, KingTest.class, TurnTest.class, InterpreterTest.class})
